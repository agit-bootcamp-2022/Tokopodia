...
namespace Tokopodia.Data
{
  public class DbInitializer
  {
    ...
    public static void Initialize(AppDbContext context)
    {
      ...
      var carts = new Cart[]
      {
                new Cart() { BuyerId = 1, ProductId = 1, SellerId = 1, Quantity = 1, BillingSeller = 300000, LatSeller = -6.225407736894751, LongSeller = 106.94341773119231, LatBuyer = -6.206607748846436, LongBuyer = 106.94433053307974, ShippingTypeId = 1, ShippingCost = 11000, Status = "OnTransaction"},
                new Cart() { BuyerId = 1, ProductId = 2, SellerId = 1, Quantity = 1, BillingSeller = 350000, LatSeller = -6.225407736894751, LongSeller = 106.94341773119231, LatBuyer = -6.206607748846436, LongBuyer = 106.94433053307974, ShippingTypeId = 1, ShippingCost = 11000, Status = "OnTransaction"},
                new Cart() { BuyerId = 1, ProductId = 4, SellerId = 2, Quantity = 1, BillingSeller = 100000, LatSeller = -6.217151172929278, LongSeller = 106.92365729212868, LatBuyer = -6.206607748846436, LongBuyer = 106.94433053307974, ShippingTypeId = 1, ShippingCost = 11000, Status = "OnTransaction"},
                new Cart() { BuyerId = 2, ProductId = 5, SellerId = 2, Quantity = 1, BillingSeller = 100000, LatSeller = -6.217151172929278, LongSeller = 106.92365729212868, LatBuyer = -6.204530320309839, LongBuyer = 106.94925525069073, ShippingTypeId = 2, ShippingCost = 11000, Status = "OnCart"},
                new Cart() { BuyerId = 2, ProductId = 6, SellerId = 2, Quantity = 1, BillingSeller = 3000000, LatSeller = -6.217151172929278, LongSeller = 106.92365729212868, LatBuyer = -6.204530320309839, LongBuyer = 106.94925525069073, ShippingTypeId = 2, ShippingCost = 11000, Status = "OnCart"}
      };
